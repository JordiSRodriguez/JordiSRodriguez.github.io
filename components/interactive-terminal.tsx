  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-10 right-4 z-40 p-3 bg-git-branch hover:bg-git-branch/90 text-white rounded-full shadow-lg hover:shadow-xl hover:shadow-git-branch/30 transition-all duration-300 group"
